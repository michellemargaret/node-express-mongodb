module.exports = (app) => {
  ...
  const itemDictionary = require("../controllers/itemDictionary.controller.js");
  ...
  // Create a new DictionaryItem
  router.post("/itemDict", itemDictionary.create);
  ...
  // Retreive all dictionary items
  router.get("/itemDict/", itemDictionary.findAll);
